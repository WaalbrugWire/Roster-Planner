...
@XStreamAlias("ShiftType5DaysPattern")
public class ShiftType5DaysPattern extends Pattern {
    ...
    private ShiftType dayIndex4ShiftType;
    ...
    public ShiftType getDayIndex4ShiftType() {
        return dayIndex4ShiftType;
    }

    public void setDayIndex4ShiftType(ShiftType dayIndex4ShiftType) {
        this.dayIndex4ShiftType = dayIndex4ShiftType;
    }
    
    @Override
    public String toString() {
        return "Work pattern: " + dayIndex0ShiftType + ", " + dayIndex1ShiftType + ", " + dayIndex2ShiftType + ", " + dayIndex3ShiftType + ", " + dayIndex4ShiftType;
    }
