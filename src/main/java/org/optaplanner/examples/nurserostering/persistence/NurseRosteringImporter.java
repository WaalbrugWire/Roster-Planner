...
import org.optaplanner.examples.nurserostering.domain.pattern.ShiftType5DaysPattern;
...
public class NurseRosteringImporter extends AbstractXmlSolutionImporter<NurseRoster>
{
    ...
    public static class NurseRosteringInputBuilder extends XmlInputBuilder<NurseRoster>
    {
        ...
        //changed from private to public, waalbrugwire, 19-2-2018
        public void generateShiftDateList(NurseRoster nurseRoster,
        ...
        //changed from private to public, waalbrugwire, 19-2-2018
        public void generateNurseRosterInfo(NurseRoster nurseRoster)
        {
        ...
        public void generateShiftList(NurseRoster nurseRoster) throws JDOMException
        {
            List<ShiftType> shiftTypeList = nurseRoster.getShiftTypeList();
            //debug prints  WaalbrugWire, 8-5-2018
            if (shiftDateMap == null)
            {
                System.out.println("Shiftdatemap is null");
            }
            if (shiftTypeList == null)
            {
                System.out.println("Shifttypelist is null");
            }
            //end of debug prints
            ...
            else
            {
                ...
                for (Element element : patternElementList)
                {
                    ...
                    else
                    {
                        switch (patternEntryElementList.size())
                        {
                            ...
                            case 3:
                                ...
                                break;
                            case 5:
                                pattern = new ShiftType5DaysPattern();
                                break;
                            default:
                    ...
                    for (Element patternEntryElement : patternEntryElementList)
                    {
                        ...
                        else if (pattern instanceof ShiftType5DaysPattern)
                        {
                            ShiftType5DaysPattern casted5DayPattern = (ShiftType5DaysPattern) pattern;
                            if (patternEntryIndex == 0)
                            {
                                if (dayOfWeek != null)
                                {
                            ...
                            {
                                case 0:
                                    casted5DayPattern.setDayIndex0ShiftType(shiftType);
                                    break;
                                case 1:
                                    casted5DayPattern.setDayIndex1ShiftType(shiftType);
                                    break;
                                case 2:
                                    casted5DayPattern.setDayIndex2ShiftType(shiftType);
                                    break;
                                case 3:
                                    casted5DayPattern.setDayIndex3ShiftType(shiftType);
                                    break;
                                case 4:
                                    casted5DayPattern.setDayIndex4ShiftType(shiftType);
                                    break;
                                default:
                                    throw new IllegalArgumentException("The patternEntryIndex ("
                                            + patternEntryIndex + ") is not supported.");
        ...
        public void createShiftAssignmentList(NurseRoster nurseRoster)
        {
    ...
    //added public wrapper to create new roster, waalbrugwire, 19-2-2018
    //dummy is to overload and not used
    //doesnt work for sytatic nested classes?

    //public void generateShiftDateList(NurseRoster nurseRoster,
    //            Element startDateElement, Element endDateElement, int dummy) throws JDOMException {
    //        NurseRosteringInputBuilder.generateShiftDateList( nurseRoster,
